...
from modelling_gamma import KVCache, PaliGemmaForConditionalGeneration
...
def top_p_sample(logits, top_p):
    ...
    probs_sort.div_(probs_sort.sum(dim=-1, keep_dim=True))
...
if __name__ == "__main__":
    # fire for parsing command line arguments
    fire.Fire(main)
